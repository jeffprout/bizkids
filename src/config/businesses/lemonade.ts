...
const LOCATIONS: LocationDef[] = [
  ...
  },
  {
    ...
    blurb: 'Saturday crowd. The stall fee is due before you pour a cup.',
    volatility: 0.2,
  },
  {
    id: 'soccer',
  ...
  },
  {
    ...
    weeklyFixedCosts: 24,
    seasons: ['summer'],
    seasonMods: { spring: 0.3, summer: 1.2, fall: 0.35, winter: 0.1 },
    blurb: 'Sun, games, and a stall that costs you either way.',
    volatility: 0.22,
  },
  {
    id: 'pumpkin-patch',
  ...
  },
  {
    ...
    weeklyFixedCosts: 22,
    seasons: ['fall'],
    seasonMods: { spring: 0.2, summer: 0.25, fall: 1.3, winter: 0.2 },
    blurb: 'Friday night lights. You pay for the gate before kickoff.',
    volatility: 0.24,
  },
  {
    id: 'winter-market',
    ...
    blurb: 'Lights and cocoa weather. The stall fee does not wait on sales.',
    volatility: 0.2,
  },
  {
    id: 'ice-rink',
