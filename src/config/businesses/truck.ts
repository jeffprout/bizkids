...
const LOCATIONS: LocationDef[] = [
  ...
  },
  {
    ...
    weeklyFixedCosts: 70,
    seasons: ['spring'],
    seasonMods: { spring: 1.15, summer: 0.4, fall: 0.5, winter: 0.15 },
    blurb: 'Saturday crowd, Saturday fee. You pay before the first stall opens.',
    volatility: 0.2,
  },
  {
    id: 'ballpark',
  ...
  },
  {
    ...
    weeklyFixedCosts: 90,
    seasons: ['summer'],
    seasonMods: { spring: 0.2, summer: 1.2, fall: 0.3, winter: 0.1 },
    blurb: 'A week of tickets. The booth fee is due whether they show or not.',
    volatility: 0.24,
  },
  {
    id: 'lake-resort',
  ...
  },
  {
    ...
    weeklyFixedCosts: 80,
    seasons: ['fall'],
    seasonMods: { spring: 0.15, summer: 0.15, fall: 1.2, winter: 0.2 },
    blurb: 'Night line, night prices. You pay for the scare before anyone screams.',
    volatility: 0.28,
  },
  {
    id: 'winter-market',
    ...
    weeklyFixedCosts: 80,
    seasons: ['winter'],
    seasonMods: { spring: 0.2, summer: 0.1, fall: 0.35, winter: 1.2 },
    blurb: 'Lights, cold nights, and a stall fee that does not wait on sales.',
    volatility: 0.22,
  },
  {
    id: 'ice-rink',
